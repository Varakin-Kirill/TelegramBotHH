    ...
    <>
      <main className={`${inter.className}`}>
        ...
        <form onSubmit={onSubmit} style={{ display: "grid", gridGap: "24px" }}>
          ...
          {partTime ? (
            <label>
              <div>На сколько часов в день нужен сотрудник.</div>
          ...
          <label>
            <div>Описание вакансии</div>
            <small>до 500 символов</small>
            <input name="cv" max="500" />
          </label>
          <label>
            <div>Зарплатная ветка</div>
            <small>(в свободной форме)</small>
            <input name="pay" />
          </label>
          <label>
            <div>Где узнать подробнее о компании</div>
            <small>
              тут можно приложить любую ссылку на что угодно - вебсайт компании,
              профиль на ХХ, что-то еще
            </small>
            <input name="video" />
          </label>
